...
## 2026-03-20 - Visual Hierarchy and Menu Psychology
**Learning:** Organizing CLI menus with color-coded headers (Yellow) and pairing actions with themed emojis (🕹️, 📜, 🛠️, 💀) reduces cognitive load and creates a more engaging, professional feel for terminal-based applications.
**Action:** Use distinct color headers and emoji pairings for main navigation menus.
