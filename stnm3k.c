...
int main() {
    ...
    if (str_contains_ignore_case(command, "ENGAGE") || strstr(command, "1") != NULL) {
        engage_defenses();
    } else {
        printf("\n%s[OFFLINE]%s Cowardice detected. The squirrels have already won. Your pillow fort is compromised.\n", RED, RESET);
    }
